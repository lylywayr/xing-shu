...
- 最终生产镜像：`xing-shu:v0.8.0`，摘要 `sha256:40f210fccc436ea4df551eebd2b298a06f52de115de2574f9af337afdfa0a96b`。
- 生产验收：容器 healthy，287 models，`/health/ready` 返回 `ready=true`；32 项管理接口契约通过。回滚备份已保留在部署目录的版本化备份文件夹中，未将真实路径写入公开文档。
